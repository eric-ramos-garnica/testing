...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type':'dessert'},{'type':'dessert'},{'type':'dessert'},{'type':'dessert'},{'type':'dessert'}, {'type':'dessert'}])
    ('dessert', 'dessert')
    >>> most_and_least_common_type([])
    (None, None)
    >>> most_and_least_common_type([{'type':'dessert'},{'type':'appetizer'},{'type':'dessert'},{'type':'appetizer'},{'type':'dessert'}, {'type':'appetizer'}])
    ('dessert', 'dessert')
